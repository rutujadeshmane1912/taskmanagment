...
const Quickdtate = ({count}) => {
  ...
  <div className=" w-[21rem]    quackdata-1  ml-10  text-white rounded-lg  border  mb-1 shadow-xl text-white-600 p-6 bg-slate-900 border-gray-400 ">
    ...
    <div className='  quackdata-2   flex gap-40 m-2'>
        <span>DEvloper</span>
    ...
    <div className='  quackdata-2  flex gap-45 m-2'> 
        <span>Tester</span>
        <h7 className="text-indigo-500 ">{count.Tester}</h7>
    </div><hr className='m-2'/>
    <div className=' quackdata-2  flex gap-40 m-3'>
        <span>Manager</span>
        <h7 className="text-indigo-500 ">{count.Manager}</h7>
    </div><hr className='m-2'/>
  </div>
